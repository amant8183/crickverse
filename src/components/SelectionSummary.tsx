  ...
  return (
    <div className="bg-[var(--color-bgPrimary)] border border-[var(--color-textSubtle)]/10 rounded-xl p-3 space-y-2.5">
      ...
      <div className="flex justify-between items-center">
        <span className="text-xs font-semibold text-[var(--color-textSecondary)]">Players Selected</span>
      ...
      <div>
        <div className="flex justify-between items-center mb-1.5">
          <span className="text-xs font-semibold text-[var(--color-textSecondary)]">Credits Remaining</span>
          <span className={`text-base font-bold ${
            creditsLeft < 10 
              ? "text-red-600" 
              : creditsLeft < 30 
      ...
      <div className="flex justify-around items-center pt-2 border-t border-[var(--color-textSubtle)]/10">
        <div className="flex items-center gap-1.5">
          <span className="text-xs text-[var(--color-textSecondary)]">🏏 BAT</span>
          <span className="text-lg font-bold text-[var(--color-textPrimary)]">{batsmen}</span>
        </div>
        <div className="flex items-center gap-1.5">
          <span className="text-xs text-[var(--color-textSecondary)]">🎯 AR</span>
          <span className="text-lg font-bold text-[var(--color-textPrimary)]">{allRounders}</span>
        </div>
        <div className="flex items-center gap-1.5">
          <span className="text-xs text-[var(--color-textSecondary)]">⚾ BOWL</span>
          <span className="text-lg font-bold text-[var(--color-textPrimary)]">{bowlers}</span>
        </div>
        <div className="flex items-center gap-1.5">
          <span className="text-xs text-[var(--color-textSecondary)]">🧤 WK</span>
          <span className="text-lg font-bold text-[var(--color-textPrimary)]">{keepers}</span>
        </div>
      </div>
    </div>
  );
