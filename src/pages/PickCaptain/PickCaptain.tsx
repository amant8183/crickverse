...
export default function PickCaptain() {
  ...
  // Required for Team Logos + counts (copied from PickPlayers)
  ...
  const creditsLeft = 100 - players.reduce((sum, p) => sum + p.event_player_credit, 0);
  ...
  return (
    <div className="h-screen pt-14 min-h-0 flex flex-col bg-[var(--color-bgPrimary)]">
      ...
      <div className="flex-shrink-0 bg-[var(--color-primary)] px-4 py-3 flex items-center gap-3">
        ...
        <h1 className="text-lg font-semibold text-white">Pick Captain & Vice-Captain</h1>
      </div>
